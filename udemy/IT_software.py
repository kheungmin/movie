...
url = "https://www.udemy.com/api-2.0/discovery-units/all_courses/?p=1&page_size=16&subcategory=&instructional_level=&lang=&price=&duration=&closed_captions=&subs_filter_type=&subcategory_id=140&source_page=subcategory_page&locale=ko_KR&currency=krw&navigation_locale=en_US&skip_price=true&sos=ps&fl=scat"
...
page_url2 = "&page_size=16&subcategory=&instructional_level=&lang=&price=&duration=&closed_captions=&subs_filter_type=&subcategory_id=140&source_page=subcategory_page&locale=ko_KR&currency=krw&navigation_locale=en_US&skip_price=true&sos=ps&fl=scat"


# < 페이지 크롤링 코드 - (IT - IT기타 및 소프트웨어) 624p>
...
#print(lecture_list)
lecture_list.to_csv("IT_software.csv", index=False)
# f = open(f'{}.csv', 'w', encoding='utf-8', newline='')
# csvWriter = csv.writer(f)
# for k in abcList:
#     csvWriter.writerow(k)
# f.close()

#merge_list = list(zip(lecture_title,lecture_url,lecture_instructor,lecture_rating,lecture_cou_rating,
#lecture_num_subscriber,lecture_total,lecture_total_time))