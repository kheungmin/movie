...
# < 개발 - 데이터과학 >
url = "https://www.udemy.com/api-2.0/discovery-units/all_courses/?p=1&page_size=16&subcategory=&instructional_level=&lang=&price=&duration=&closed_captions=&subs_filter_type=&subcategory_id=558&source_page=subcategory_page&locale=ko_KR&currency=krw&navigation_locale=en_US&skip_price=true&sos=ps&fl=scat"
...
page_url2 = "&page_size=16&subcategory=&instructional_level=&lang=&price=&duration=&closed_captions=&subs_filter_type=&subcategory_id=558&source_page=subcategory_page&locale=ko_KR&currency=krw&navigation_locale=en_US&skip_price=true&sos=ps&fl=scat"
#"https://www.udemy.com/api-2.0/discovery-units/all_courses/?p=1&page_size=16&subcategory=&instructional_level=&lang=&price=&duration=&closed_captions=&subs_filter_type=&subcategory_id=558&source_page=subcategory_page&locale=ko_KR&currency=krw&navigation_locale=en_US&skip_price=true&sos=ps&fl=scat"
# 카테고리 변환을 위한 코드
#cate_url1 = ""
#cate_url1 = ""
#url = ""
# < 페이지 크롤링 코드 - (개발 - 데이터과학) 158p>
...
# print(result['unit']['items'][0]['title'])
# print(result['unit']['items'][5]['title'])
# print(result['unit']['items'][10]['title'])
# print(result['unit']['items'][15]['title'])
# print(site_url+result['unit']['items'][15]['url'])
...
#print(lecture_list)
lecture_list.to_csv("devel_d_science.csv", index=False)