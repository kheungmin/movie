...
# 개발- [1웹개발, 2데이터과학, 3모바일 개발, 4프로그래밍언어, 5게임개발, 6데이터베이스설계및개발, 7소프트웨어테스팅, 8소프트웨어엔지니어링, 9소프트웨어개발도구, 10노코드개발]

url = "https://www.udemy.com/api-2.0/discovery-units/all_courses/?p=1&page_size=16&subcategory=&instructional_level=&lang=&price=&duration=&closed_captions=&subs_filter_type=&subcategory_id=362&source_page=subcategory_page&locale=ko_KR&currency=krw&navigation_locale=en_US&skip_price=true&sos=ps&fl=scat"
...
page_url2 = "&page_size=16&subcategory=&instructional_level=&lang=&price=&duration=&closed_captions=&subs_filter_type=&subcategory_id=362&source_page=subcategory_page&locale=ko_KR&currency=krw&navigation_locale=en_US&skip_price=true&sos=ps&fl=scat"


# < 페이지 크롤링 코드 - (개발 - 소프트웨어 도구) 90p>
...
#print(lecture_list)
lecture_list.to_csv("devel_software_tool.csv", index=False)        